                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="classes-item">
                            ...
                            <div class="bg-light rounded-circle w-75 mx-auto p-3">
                                <img class="img-fluid rounded-circle" src="{{ asset('assets/images/'.$class->class_image) }}" alt="" style="max-width: 250px; height:300px" alt="">
                            </div>
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h6 class="text-primary mb-1">{{$class->teacher->teacherName}}</h6>
                                            <small>Teacher</small>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-1">
                                    <div class="col-4">
                                        <div class="border-top border-3 border-primary pt-2">
                                            ...
                                            <small>{{$class->fromAge}}-{{$class->toAge}} Years</small>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="border-top border-3 border-success pt-2">
                                            <h6 class="text-success mb-1">Time:</h6>
                                            <small>{{$class->fromTime}}</small>
                                            <small>{{$class->toTime}}</small>
                                        </div>
                                    </div>
                                    <div class="col-4">
