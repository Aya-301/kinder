            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle {{ (request()->routeIs('facilities') || request()->routeIs('teachers') || request()->routeIs('becomeAteacher') || request()->routeIs('appointment') || request()->routeIs('testimonials') ) ? 'active' : '' }}" data-bs-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                            <a href="{{route('facilities')}}" class="dropdown-item">School Facilities</a>
                            <a href="{{route('teachers')}}" class="dropdown-item">Popular Teachers</a>
                            <a href="{{route('becomeAteacher')}}" class="dropdown-item">Become A Teachers</a>
